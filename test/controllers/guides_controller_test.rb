...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post guides_url, params: { guide: { tacking: @guide.tacking, user_id: @guide.user_id } }
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { tacking: @guide.tacking, user_id: @guide.user_id } }
