...
class PreOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pre_order" do
    assert_difference('PreOrder.count') do
      post pre_orders_url, params: { pre_order: { tracking_id: @pre_order.tracking_id, user_id: @pre_order.user_id } }
    end
  ...
  test "should update pre_order" do
    patch pre_order_url(@pre_order), params: { pre_order: { tracking_id: @pre_order.tracking_id, user_id: @pre_order.user_id } }
