...
class BuysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buy" do
    assert_difference('Buy.count') do
      post buys_url, params: { buy: { code: @buy.code, description: @buy.description, sender: @buy.sender, status: @buy.status, tracking: @buy.tracking, user_id: @buy.user_id } }
    end
  ...
  test "should update buy" do
    patch buy_url(@buy), params: { buy: { code: @buy.code, description: @buy.description, sender: @buy.sender, status: @buy.status, tracking: @buy.tracking, user_id: @buy.user_id } }
